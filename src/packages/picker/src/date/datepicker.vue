...
<template>
    <div class="ms-datepicker">
        <ms-date-panel v-if="(view=='date')" :ms-datepicker-id="msDatepickerId"
                       :current-year="currentYear"
                       :current-month="currentMonth"
                       :current-date="currentDate" :change-view="changeView">
        </ms-date-panel>
        <ms-month-panel v-if="(view=='month')" :ms-datepicker-id="msDatepickerId"
                        :current-year="currentYear"
                        :current-month="currentMonth" :change-view="changeView">
        </ms-month-panel>
        <ms-year-panel v-if="(view=='year')" :ms-datepicker-id="msDatepickerId"
                       :current-year="currentYear" :change-view="changeView">
        </ms-year-panel>
    </div>
</template>
<script>
